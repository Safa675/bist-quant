...
**Quantitative research and backtesting library for Borsa Istanbul (BIST).** Version 0.5.0.
...
| Screening | [src/bist_quant/screening/README.md](../src/bist_quant/screening/README.md) |
