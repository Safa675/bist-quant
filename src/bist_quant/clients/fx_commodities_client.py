...
class FXCommoditiesClient(BaseMCPClient):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            cache_ttl=cache_ttl,
            cache_dir=cache_dir,
            disk_cache_category="commodities",
        )
    ...
    # _extract_text_blocks is inherited from BaseMCPClient
    ...
    # _cache_get, _cache_set, and _to_float are inherited from BaseMCPClient
