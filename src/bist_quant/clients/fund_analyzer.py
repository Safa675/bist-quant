...
class TEFASAnalyzer(BaseMCPClient):
    ...
    # _call_mcp_async, close, _cache_get, _cache_set, and _extract_text_blocks are inherited from BaseMCPClient
    ...
    # _to_float is inherited from BaseMCPClient
...
# Backward-compatible alias for callers expecting FundAnalyzer.
FundAnalyzer = TEFASAnalyzer
