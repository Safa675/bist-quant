"""
Macro Hedge Factor Configuration
...
SIGNAL_CONFIG = {
    'name': 'macro_hedge',
    'enabled': True,
    'rebalance_frequency': 'quarterly',  # Defensive stocks are stable, quarterly is fine
    'timeline': {
        'start_date': '2017-01-01',  # Fundamental data starts 2016-06, use 2017
        'end_date': '2026-12-31',
    },
    'description': 'Fortress balance sheet stocks (low debt, high cash, positive CF) for macro protection',

    # Portfolio engineering options
    'portfolio_options': {
        # Regime filter - switches to gold in Bear/Stress regimes
        'use_regime_filter': False,  # Enable regime filter - these stocks shine in stress
