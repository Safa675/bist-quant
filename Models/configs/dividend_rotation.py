"""
Dividend Rotation Factor Configuration

Identifies high-quality dividend stocks during rate normalization periods.
"""

SIGNAL_CONFIG = {
    'name': 'dividend_rotation',
    'enabled': True,
    'rebalance_frequency': 'quarterly',  # Dividend stocks are more stable, quarterly is fine
    'timeline': {
        'start_date': '2017-01-01',  # Fundamental data starts 2016-06, use 2017
        'end_date': '2026-12-31',
    },
    'description': 'High dividend yield + low volatility + earnings growth during rate normalization',

    # Portfolio engineering options
    'portfolio_options': {
        # Regime filter - switches to gold in Bear/Stress regimes
        'use_regime_filter': False,  # Enable regime filter for macro-aware signal
