"""
ATR Low-Volatility Signal Configuration

ATR(14) low-volatility strategy:
- Lower ATR/price = calmer stock = higher score
...
SIGNAL_CONFIG = {
    ...
    'description': 'ATR(14) low-volatility - calmer stocks rank highest',
    'parameters': {
        'period': 14,
    },
    'portfolio_options': {
