"""
EMA Crossover Signal Configuration

EMA(12/26) crossover strategy:
- Bullish when 12-day EMA > 26-day EMA
- Bearish when 12-day EMA < 26-day EMA
"""
...
SIGNAL_CONFIG = {
    ...
    'description': 'EMA(12/26) crossover - bullish when short EMA > long EMA',
    'parameters': {
        'short_period': 12,
        'long_period': 26,
    },
