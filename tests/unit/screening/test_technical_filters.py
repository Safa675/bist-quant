"""Unit tests for screener technical scan integration."""
...
def test_run_response_applies_technical_scan(monkeypatch, tmp_path) -> None:
    ...
    def fake_scan(self, universe, condition, interval, template=None):  # noqa: ANN001
    ...
    monkeypatch.setattr(TechnicalScanner, "scan", fake_scan)
